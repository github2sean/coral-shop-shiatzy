...
<div class="mail-change" style="padding-bottom: 15px;">
    <form class="j_ajaxForm" action="/u/account/updateEmail" method="post">
...
<div class="password-change">
    <form class="j_ajaxForm" action="/u/account/updatePassword" method="post">
    <div class="register-mail">
