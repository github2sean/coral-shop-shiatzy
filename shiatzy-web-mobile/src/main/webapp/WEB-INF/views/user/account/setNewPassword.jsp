...
<div class="password-change">
    ...
    <div class="register-mail content">
        ...
        <button type="button" class="btn-default"><spring:message code="account.personal.updateEmailOrPass.confirmChange"/></button>
...
<script>
    $(function () {
        ...
        $(".btn-default").click(function(){
            ...
            $.post("/u/account/setNewPassword",data,function (data) {
