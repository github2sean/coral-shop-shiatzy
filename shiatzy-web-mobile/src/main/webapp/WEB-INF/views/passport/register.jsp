    ...
    <form class="j_ajaxForm" action="/passport/register.do" method="post" data-next="${ctx}/passport/toLogin">
        <div class="dx-form">
            ...
            <c:if test="${web:selectLanguage()!='en_US'}">
                <div class="form-item text-center" style="word-break: break-all;font-size: 12px">完成注册，表示您已同意接受Shop.shiatzychen.com 的<a href="#" class="privacyNotice" style="color:#000;text-decoration:underline;">隐私政策</a>及相关线上条例。</div>
            </c:if>
            <c:if test="${web:selectLanguage()=='en_US'}">
                <div class="form-item text-center" style="word-break: break-all;font-size: 12px">Complete the registration, you have agreed to accept shop.shiatzychen.com's <a href="#" class="privacyNotice" style="color:#000;text-decoration:underline;">privacy policies</a> and regulations related to online.
                </div>
            </c:if>
        </div>
    </form>
