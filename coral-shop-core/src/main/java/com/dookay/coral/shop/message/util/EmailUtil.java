...
public class EmailUtil {
    ...
    private static IReservationService reservationService = SpringContextHolder.getBean("reservationService");
    ...
    //预约
    public static void submitOrder(Boolean isEN, String email, ReservationDomain reservationDomain, List<ReservationItemDomain> requestList, Double totalAmt) {
        MessageTemplateQuery query = new MessageTemplateQuery();
        query.setType(1);
        ...
        freeMap.put("openDate", reservationDomain.getStoreDomain() != null ? reservationDomain.getStoreDomain().getTime() :"");
